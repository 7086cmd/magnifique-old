...
let { language, modelValue: value, width: editorWidth, height: editorHeight } = toRefs(props)
...
<template>
  <div ref="editor" :style="'width: ' + editorWidth + '; height: ' + editorHeight + '; text-align: left'"></div>
</template>
